<template>
  <div class="movie-info-wrap">
    <header class="movie-info-header">
      <h6 class="movie-info-title">Movie view</h6>
    ...
    <div class="movie-info-content">
      <BRow>
        ...
        <BCol sm="8">
          ...
          <div class="mt-3 mb-4">
            <BBadge class="success" variant="success">{{ movie.Year }}</BBadge>
            <BBadge class="success" variant="success">{{
              movie.Runtime
            }}</BBadge>
            <BBadge class="success" variant="success">{{ movie.Genre }}</BBadge>
            <BBadge class="success" variant="success">{{
              movie.Language
            }}</BBadge>
          </div>
